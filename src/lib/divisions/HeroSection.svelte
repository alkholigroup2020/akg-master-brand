...
<section class="max-w-[1920px] mx-auto">
	<div class="relative" dir={$pageDirection}>
		...
		<img
			...
			src="/images/divisions/heroSection/banner-divisions_1920x768.webp"
			srcset="/images/divisions/heroSection/banner-divisions_700x560.webp 640w, 	 
			/images/divisions/heroSection/banner-divisions_1200x720.webp 1024w, 
			/images/divisions/heroSection/banner-divisions_1600x800.webp 1536w, 
			/images/divisions/heroSection/banner-divisions_1920x768.webp 9000w"
