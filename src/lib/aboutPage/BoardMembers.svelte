...
<section class="max-w-[1920px] mx-auto">
	<div
		class="text-white text-center bg-primary-500 flex flex-col pt-8 xl:pt-12 pb-12 md:pb-16 xl:pb-24 uppercase"
	>
		<!-- title -->
			...
			<div class="flex flex-col items-center" bind:this={imageRefs[0]}>
				<div>
					<img
						...
						alt="chairman"
						class="aspect-[1/1] w-28 h-28 md:w-36 md:h-36 xl:w-48 xl:h-48 border-2 rounded-full"
					/>
				</div>
		...
		<!-- board level -->
		<div
			class="grid min-[380px]:grid-cols-2 lg:grid-cols-4
			gap-8 xl:gap-0
			min-[380px]:px-10 min-[550px]:px-24 min-[650px]:px-32 md:px-36 lg:px-12 xl:px-16 2xl:px-48"
		>
			<div class="flex flex-col items-center w-full" bind:this={imageRefs[1]}>
				<div>
					<img
						...
						alt="Vice Chairman"
						class="aspect-[1/1] rounded-full w-24 h-24 md:w-32 md:h-32 xl:w-36 xl:h-36 border-2"
					/>
				</div>
				<p class="pt-5 heading text-sm sm:text-base md:text-lg xl:text-xl">Faisal Alkholi</p>
				<p class="pt-2 text-sm sm:text-base md:text-lg xl:text-xl capitalize">Vice Chairman</p>
			</div>

			<div class="flex flex-col items-center w-full" bind:this={imageRefs[2]}>
				<div>
					<img
			...
			<div class="flex flex-col items-center w-full" bind:this={imageRefs[3]}>
				<div>
					<img
			...
			<div class="flex flex-col items-center w-full" bind:this={imageRefs[4]}>
				<div>
					<img
