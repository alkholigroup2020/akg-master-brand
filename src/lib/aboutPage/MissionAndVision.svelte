...
<section class="max-w-[1920px] mx-auto bg-primary-500 text-white">
	<div class="container mx-auto px-3 py-5 xl:py-12 {$currentAppLang === 'ar' ? 'ar-font' : ''}">
		<div class="sm:flex 2xl:px-32">
			<div
				bind:this={itemsRefs[0]}
				class="sm:w-1/2 min-[400px]:px-12 min-[550px]:px-16 sm:px-5 md:px-8 xl:px-24 2xl:px-12 py-5"
			>
			...
			>
				<div class="flex flex-col items-center">
					<img
						src="/images/about/visionAndMission/idea_300x300.webp"
						srcset="
            /images/about/visionAndMission/idea_200x200.webp 1280w,
            /images/about/visionAndMission/idea_300x300.webp 2000w
            "
						class="aspect-[1/1] w-28 h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 2xl:w-44 2xl:h-44"
						alt="our vision"
					/>
